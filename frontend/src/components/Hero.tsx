...
export default function Hero() {
  return (
    <section className="relative h-[70vh] flex items-center justify-center font-roboto text-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/hero.jpg')" }}>
      <div className="absolute inset-0 bg-[#40576d]/55 backdrop-blur-sm" />
      ...
      <div className="relative z-10 max-w-2xl px-4">
        ...
        <button className="bg-[#536a86] text-white px-6 py-3 rounded-full shadow hover:bg-[#40576d] transition">
          Ver servicios
        </button>
      </div>
