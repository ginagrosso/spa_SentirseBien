...
export default function Hero() {
  return (
    <section className="relative h-[50vh] flex items-center justify-center font-roboto text-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/hero.png')" }}>
